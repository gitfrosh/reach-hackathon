...
import { Space, Row, PageHeader, Input, Avatar, Button, Comment, Form, Card } from 'antd';
...
export class BackendRunning extends React.Component {
  ...
  render() {
    ...
    console.log(ctcInfo, ctcInfoStr)
  ...
  />
          ...
          style={{ textAlign: 'right'}}
            content={
              <>              <Form.Item>
                <TextArea  value={this.state.info}         placeholder='cats are frens'
 style={{ maxWidth: '90%' }} maxLength={200} rows={4} onChange={(e) => {
                ...
                <div style={{ textAlign: "right" }}>
                  ...
                  <Form.Item>
                    <Button onClick={() => {
                      parent.enterMeow(this.state.info || defaultInfo)
                      this.setState({ info: '' })
                    }} type="primary">
                      meow!
                    </Button>
...
export class CreatorWrapper extends React.Component {
  render() {
    ...
    return (
      <Card style={{ backgroundColor: '#edf6ff'}}>
        {alice}
      </Card>
    );
  }
